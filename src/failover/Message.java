...
/**
 * This is a message that gets sent between eNodeBs and Controllers
 * 
 * @author nathankong
 *
 */
public class Message {
	...
	/**
	 * Used for the controller's adoption message
	 * 
	 * @param c
	 *            the controller
	 */
	...
	/**
	 * Used for controller messages to orphan eNodeBs. Tells the orphan the
	...
	/**
	 * Adds the last eNodeB that sends the orphan message
	 * 
	 * @param e
	 */
	...
	/**
	 * Getting the breadcrumb when the controller responses to the orphan
	 * message
	 * 
	...
	/**
	 * Gets the Orphan eNodeB when 1) sending messages to the controller 2)
	 * determining who the orphan is
	 * 
