...
public class Simulation3a {
	...
	private static void system() {
		...
		ENodeB B0 = new ENodeB(0, maxTime, lowLoad, 0);
		eNodeBs.add(B0);
		ENodeB B1 = new ENodeB(1, maxTime, lowLoad, 1);
		eNodeBs.add(B1);
		ENodeB B2 = new ENodeB(2, maxTime, lowLoad, 1);
		eNodeBs.add(B2);
		ENodeB B3 = new ENodeB(3, maxTime, lowLoad, 1);
		eNodeBs.add(B3);
		ENodeB B4 = new ENodeB(4, maxTime, lowLoad, 1);
		eNodeBs.add(B4);
		ENodeB B5 = new ENodeB(5, maxTime, lowLoad, 1);
		eNodeBs.add(B5);
		ENodeB B6 = new ENodeB(6, maxTime, lowLoad, 1);
		eNodeBs.add(B6);
		ENodeB B7 = new ENodeB(7, maxTime, highLoad, 2);
		eNodeBs.add(B7);
